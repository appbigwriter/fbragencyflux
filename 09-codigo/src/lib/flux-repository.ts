...
export type Handoff = { id: string; cardId: string; project: string; from: string; to: string; summary: string; done: string; risks: string; nextStep: string; acceptanceCriteria: string; evidenceRef: string; createdAt: string; blockers?: BlockerInput[]; blockerId?: string; jobId?: string; correlationId?: string; solution?: Pick<Blocker, 'cause' | 'owner' | 'nextAction' | 'resolutionPlan' | 'resolutionEvidence'>; sourceType?: 'local' | 'filesystem'; historical?: boolean; activeBlocker?: boolean }
