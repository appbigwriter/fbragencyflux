# Documentação para Dev — Agency Flux

## 1. Identidade do projeto

- **Project ID:** `9c8ababb-7cb6-4b67-b0a4-c9c6f9e78c2f`
- **Slug:** `agency`
- **Tipo:** `custom`
- **Template:** `custom_base` (v1.0.0)
- **Schema exclusivo:** `custom_agency`
- **Domínio oficial:** agency.fbr.news
- **Domínio de validação:** https://agency.fbr.news/health
- **Namespace:** `fbr/custom/9c8ababb-7cb6-4b67-b0a4-c9c6f9e78c2f`
- **Target:** `vps2`
- **Repository path:** `/09-codigo`
- **Easypanel project:** `sistemas`
- **Easypanel service:** `agency`
...
CONTROL_TOWER_PROJECT_ID=9c8ababb-7cb6-4b67-b0a4-c9c6f9e78c2f
CONTROL_TOWER_SCHEMA_NAME=custom_agency
...
SUPABASE_ANON_KEY=<secret-manager:fbr/custom/9c8ababb-7cb6-4b67-b0a4-c9c6f9e78c2f/SUPABASE_ANON_KEY>
...
- Operar exclusivamente no schema `custom_agency`.
...
- [ ] https://agency.fbr.news/health retorna HTTP 200.
