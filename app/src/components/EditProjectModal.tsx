            ...
            <div className="space-y-4 animate-in fade-in duration-300">
              <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-300">O briefing e o prompt do Gestor Hermes foram sincronizados no disco.</p>
                  </div>
                </div>
                ...
                >
                  ...
                  <span>{copied ? 'Copiado!' : 'Copiar Novo Prompt'}</span>
                </button>
              </div>
              ...
              <div>
                <label className="block text-xs font-bold text-slate-300 mb-2 flex items-center gap-2">
                  ...
                  <span>Prompt do Agente Hermes Atualizado:</span>
                </label>
