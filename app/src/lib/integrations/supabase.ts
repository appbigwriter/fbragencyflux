...
const DEFAULT_DATABASE_URL = 'postgresql://postgres.supabase-vps2:ffff332788fcc1ae8a484930fd1e3272@76.13.168.223:15432/postgres';

let pgPool: Pool | null = null;

export function getPgPool(): Pool {
  if (!pgPool) {
    const connStr = process.env.DATABASE_URL || process.env.FLUX_DATABASE_URL || DEFAULT_DATABASE_URL;
    pgPool = new Pool({
